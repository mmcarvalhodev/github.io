...
(function () {
  ...
  var LABEL = {
    ...
    es: {
      phrase: 'Mira lo que está pasando ahora', explore: 'Explorar Insights →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: 'votos/día promedio', avgPoints: 'puntos/día promedio', avgViews: 'vistas/día promedio',
      distinctWinners: 'ganadores diferentes', distinctStories: 'historias diferentes', distinctChannels: 'canales diferentes',
      winnerEyebrow: '🏆 Ganador', topStoryEyebrow: '🔥 Historia destacada', trendingEyebrow: '📈 En tendencia', nlEyebrow: '✉️ Newsletter',
      openDashboard: 'Abrir panel →', install: 'Instalar {name} →', subscribe: 'Suscribirse →',
      nlMoreLabel: 'También en tendencia esta semana', nlCuratedBy: 'Seleccionado por {user}', subscribeTo: 'Suscribirse a {name} →',
    },
    fr: {
      phrase: 'Découvrez ce qui se passe maintenant', explore: 'Explorer Insights →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: 'votes/jour en moyenne', avgPoints: 'points/jour en moyenne', avgViews: 'vues/jour en moyenne',
      distinctWinners: 'gagnants différents', distinctStories: 'histoires différentes', distinctChannels: 'chaînes différentes',
      winnerEyebrow: '🏆 Gagnant', topStoryEyebrow: '🔥 Histoire phare', trendingEyebrow: '📈 Tendance actuelle', nlEyebrow: '✉️ Newsletter',
      openDashboard: 'Ouvrir le tableau de bord →', install: 'Installer {name} →', subscribe: 'S\'abonner →',
      nlMoreLabel: 'Aussi en tendance cette semaine', nlCuratedBy: 'Sélectionné par {user}', subscribeTo: 'S\'abonner à {name} →',
    },
    de: {
      phrase: 'Sieh, was gerade passiert', explore: 'Insights entdecken →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: 'Stimmen/Tag im Schnitt', avgPoints: 'Punkte/Tag im Schnitt', avgViews: 'Aufrufe/Tag im Schnitt',
      distinctWinners: 'verschiedene Gewinner', distinctStories: 'verschiedene Storys', distinctChannels: 'verschiedene Kanäle',
      winnerEyebrow: '🏆 Gewinner', topStoryEyebrow: '🔥 Top-Story', trendingEyebrow: '📈 Im Trend', nlEyebrow: '✉️ Newsletter',
      openDashboard: 'Dashboard öffnen →', install: '{name} installieren →', subscribe: 'Abonnieren →',
      nlMoreLabel: 'Ebenfalls im Trend diese Woche', nlCuratedBy: 'Kuratiert von {user}', subscribeTo: '{name} abonnieren →',
    },
    it: {
      phrase: 'Guarda cosa sta succedendo ora', explore: 'Esplora Insights →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: 'voti/giorno in media', avgPoints: 'punti/giorno in media', avgViews: 'visualizzazioni/giorno in media',
      distinctWinners: 'vincitori diversi', distinctStories: 'storie diverse', distinctChannels: 'canali diversi',
      winnerEyebrow: '🏆 Vincitore', topStoryEyebrow: '🔥 Storia del giorno', trendingEyebrow: '📈 Di tendenza ora', nlEyebrow: '✉️ Newsletter',
      openDashboard: 'Apri dashboard →', install: 'Installa {name} →', subscribe: 'Iscriviti →',
      nlMoreLabel: 'Anche di tendenza questa settimana', nlCuratedBy: 'Selezionato da {user}', subscribeTo: 'Iscriviti a {name} →',
    },
    nl: {
      phrase: 'Bekijk wat er nu gebeurt', explore: 'Insights verkennen →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: 'stemmen/dag gemiddeld', avgPoints: 'punten/dag gemiddeld', avgViews: 'weergaven/dag gemiddeld',
      distinctWinners: 'verschillende winnaars', distinctStories: 'verschillende verhalen', distinctChannels: 'verschillende kanalen',
      winnerEyebrow: '🏆 Winnaar', topStoryEyebrow: '🔥 Topverhaal', trendingEyebrow: '📈 Nu trending', nlEyebrow: '✉️ Newsletter',
      openDashboard: 'Dashboard openen →', install: '{name} installeren →', subscribe: 'Abonneren →',
      nlMoreLabel: 'Ook trending deze week', nlCuratedBy: 'Samengesteld door {user}', subscribeTo: 'Abonneren op {name} →',
    },
    pl: {
      phrase: 'Zobacz, co dzieje się teraz', explore: 'Odkryj Insights →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: 'śr. głosów/dzień', avgPoints: 'śr. punktów/dzień', avgViews: 'śr. wyświetleń/dzień',
      distinctWinners: 'różnych zwycięzców', distinctStories: 'różnych historii', distinctChannels: 'różnych kanałów',
      winnerEyebrow: '🏆 Zwycięzca', topStoryEyebrow: '🔥 Najlepsza historia', trendingEyebrow: '📈 Na czasie', nlEyebrow: '✉️ Newsletter',
      openDashboard: 'Otwórz panel →', install: 'Zainstaluj {name} →', subscribe: 'Subskrybuj →',
      nlMoreLabel: 'Też na fali w tym tygodniu', nlCuratedBy: 'Wybrane przez {user}', subscribeTo: 'Subskrybuj {name} →',
    },
    id: {
      phrase: 'Lihat apa yang sedang terjadi sekarang', explore: 'Jelajahi Insights →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: 'rata-rata suara/hari', avgPoints: 'rata-rata poin/hari', avgViews: 'rata-rata tontonan/hari',
      distinctWinners: 'pemenang berbeda', distinctStories: 'cerita berbeda', distinctChannels: 'kanal berbeda',
      winnerEyebrow: '🏆 Pemenang', topStoryEyebrow: '🔥 Cerita teratas', trendingEyebrow: '📈 Sedang tren', nlEyebrow: '✉️ Newsletter',
      openDashboard: 'Buka dasbor →', install: 'Instal {name} →', subscribe: 'Berlangganan →',
      nlMoreLabel: 'Juga sedang tren minggu ini', nlCuratedBy: 'Dikurasi oleh {user}', subscribeTo: 'Berlangganan {name} →',
    },
    vi: {
      phrase: 'Xem những gì đang diễn ra ngay bây giờ', explore: 'Khám phá Insights →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: 'lượt bình chọn/ngày trung bình', avgPoints: 'điểm/ngày trung bình', avgViews: 'lượt xem/ngày trung bình',
      distinctWinners: 'người chiến thắng khác nhau', distinctStories: 'tin khác nhau', distinctChannels: 'kênh khác nhau',
      winnerEyebrow: '🏆 Người chiến thắng', topStoryEyebrow: '🔥 Tin nổi bật', trendingEyebrow: '📈 Đang thịnh hành', nlEyebrow: '✉️ Newsletter',
      openDashboard: 'Mở bảng điều khiển →', install: 'Cài đặt {name} →', subscribe: 'Đăng ký →',
      nlMoreLabel: 'Cũng đang thịnh hành tuần này', nlCuratedBy: 'Được chọn lọc bởi {user}', subscribeTo: 'Đăng ký {name} →',
    },
    ja: {
      phrase: '今起きていることをチェック', explore: 'Insightsを見る →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: '平均投票数/日', avgPoints: '平均ポイント数/日', avgViews: '平均視聴数/日',
      distinctWinners: '異なる受賞者数', distinctStories: '異なるストーリー数', distinctChannels: '異なるチャンネル数',
      winnerEyebrow: '🏆 ウィナー', topStoryEyebrow: '🔥 注目ストーリー', trendingEyebrow: '📈 急上昇中', nlEyebrow: '✉️ Newsletter',
      openDashboard: 'ダッシュボードを開く →', install: '{name}をインストール →', subscribe: '購読する →',
      nlMoreLabel: '今週の他の注目ニュースレター', nlCuratedBy: '{user}が厳選', subscribeTo: '{name}を購読する →',
    },
    ko: {
      phrase: '지금 무슨 일이 일어나고 있는지 확인하세요', explore: 'Insights 살펴보기 →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: '일 평균 투표수', avgPoints: '일 평균 포인트', avgViews: '일 평균 조회수',
      distinctWinners: '서로 다른 우승자', distinctStories: '서로 다른 스토리', distinctChannels: '서로 다른 채널',
      winnerEyebrow: '🏆 우승자', topStoryEyebrow: '🔥 인기 스토리', trendingEyebrow: '📈 지금 인기', nlEyebrow: '✉️ Newsletter',
      openDashboard: '대시보드 열기 →', install: '{name} 설치 →', subscribe: '구독하기 →',
      nlMoreLabel: '이번 주 함께 뜨는 뉴스레터', nlCuratedBy: '{user}가 큐레이션', subscribeTo: '{name} 구독하기 →',
    },
    zh: {
      phrase: '看看现在发生了什么', explore: '探索 Insights →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: '日均投票数', avgPoints: '日均积分', avgViews: '日均播放量',
      distinctWinners: '不同冠军数', distinctStories: '不同故事数', distinctChannels: '不同频道数',
      winnerEyebrow: '🏆 冠军', topStoryEyebrow: '🔥 热门故事', trendingEyebrow: '📈 正在热门', nlEyebrow: '✉️ Newsletter',
      openDashboard: '打开仪表盘 →', install: '安装 {name} →', subscribe: '订阅 →',
      nlMoreLabel: '本周同样热门', nlCuratedBy: '由 {user} 精选', subscribeTo: '订阅 {name} →',
    },
    ru: {
      phrase: 'Смотрите, что происходит прямо сейчас', explore: 'Смотреть Insights →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: 'голосов/день в среднем', avgPoints: 'баллов/день в среднем', avgViews: 'просмотров/день в среднем',
      distinctWinners: 'разных победителей', distinctStories: 'разных новостей', distinctChannels: 'разных каналов',
      winnerEyebrow: '🏆 Победитель', topStoryEyebrow: '🔥 Главная новость', trendingEyebrow: '📈 В тренде', nlEyebrow: '✉️ Newsletter',
      openDashboard: 'Открыть панель →', install: 'Установить {name} →', subscribe: 'Подписаться →',
      nlMoreLabel: 'Также в тренде на этой неделе', nlCuratedBy: 'Подобрано {user}', subscribeTo: 'Подписаться на {name} →',
    },
    hi: {
      phrase: 'अभी क्या हो रहा है देखें', explore: 'Insights देखें →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: 'औसत वोट/दिन', avgPoints: 'औसत पॉइंट/दिन', avgViews: 'औसत व्यूज़/दिन',
      distinctWinners: 'अलग-अलग विजेता', distinctStories: 'अलग-अलग स्टोरीज़', distinctChannels: 'अलग-अलग चैनल',
      winnerEyebrow: '🏆 विजेता', topStoryEyebrow: '🔥 टॉप स्टोरी', trendingEyebrow: '📈 अभी ट्रेंडिंग', nlEyebrow: '✉️ Newsletter',
      openDashboard: 'डैशबोर्ड खोलें →', install: '{name} इंस्टॉल करें →', subscribe: 'सब्सक्राइब करें →',
      nlMoreLabel: 'इस सप्ताह और भी ट्रेंडिंग', nlCuratedBy: '{user} द्वारा चुना गया', subscribeTo: '{name} सब्सक्राइब करें →',
    },
    tr: {
      phrase: 'Şu anda neler oluyor, bir bak', explore: 'Insights\'ı keşfet →',
      nlPhrase: 'Newsletters',
      ph: 'PH', hn: 'HN', yt: 'YT', nl: 'NL',
      avgVotes: 'günlük ort. oy', avgPoints: 'günlük ort. puan', avgViews: 'günlük ort. görüntülenme',
      distinctWinners: 'farklı kazanan', distinctStories: 'farklı haber', distinctChannels: 'farklı kanal',
      winnerEyebrow: '🏆 Kazanan', topStoryEyebrow: '🔥 Öne çıkan haber', trendingEyebrow: '📈 Şu anda trend', nlEyebrow: '✉️ Newsletter',
      openDashboard: 'Panoyu aç →', install: '{name}\'ı yükle →', subscribe: 'Abone ol →',
      nlMoreLabel: 'Bu hafta trend olan diğerleri', nlCuratedBy: '{user} tarafından seçildi', subscribeTo: '{name}\'a abone ol →',
    },
  };
