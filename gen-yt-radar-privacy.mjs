// Generator: bakes /[lang]/yt-radar-privacy.html from the English root.
// Single source of truth: yt-priv-i18n.mjs (exports P).
// Run: node gen-yt-radar-privacy.mjs
import fs from 'fs';
import path from 'path';
import { P } from './yt-priv-i18n.mjs';

const ROOT = 'yt-radar-privacy.html';
...
function fixPaths(html, lang){
  let h = html;
  h = h.replace(/href="yt-radar\.html"/g, 'href="/' + lang + '/yt-radar"');
  h = h.replace(/href="https:\/\/mmcarvalhodev\.github\.io\/github\.io\/"/g, 'href="/' + lang + '/"');
...
// ---- generate /[lang]/yt-radar-privacy.html ----
for (const lang of LANGS){
  ...
  h = h.replace('href="https://nodus-ai.app/yt-radar-privacy"',
                'href="https://nodus-ai.app/' + lang + '/yt-radar-privacy"');
  ...
  fs.writeFileSync(path.join(dir, 'yt-radar-privacy.html'), h, 'utf8');
  console.log('wrote', dir + '/yt-radar-privacy.html' + (missing.length ? '  (with warnings)' : ''));
}
console.log('done.');
